...
import { DatailsAnswerComponent } from './components/dashboard/questionnaire/stadistics/datails-answer/datails-answer.component';
...
const routes: Routes = [
  ...
  { path: 'dashboard', component: DashboardComponent,canActivate:[AuthGuard], children:[
    ...
    {path: 'details-answer/:id', component: DatailsAnswerComponent},
